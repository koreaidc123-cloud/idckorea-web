-- ╔═══════════════════════════════════════════════════════════════╗
-- ║  ⚠ 이미 지나간 파일입니다. 지금은 실행하지 마세요.             ║
-- ║                                                               ║
-- ║  이 안에 옛날 beat 함수가 들어 있어서, 06-B 를 돌리신 뒤에     ║
-- ║  이걸 다시 돌리면 "사라진 PC 찾기" 가 통째로 되돌아갑니다.     ║
-- ║                                                               ║
-- ║  지금 쓰실 파일                                               ║
-- ║    06-A-지금상태-보기.sql   상태 확인 (읽기만)                ║
-- ║    06-B-사라진PC-잡기.sql   사라진 PC + 원격 재부팅           ║
-- ║    07-만료정리.sql          만료 자동 처리                    ║
-- ║                                                               ║
-- ║  기록으로만 남겨 둡니다.                                      ║
-- ╚═══════════════════════════════════════════════════════════════╝
